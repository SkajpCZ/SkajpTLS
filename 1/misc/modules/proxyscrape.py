...
def scrapes():
    ...
    def steal_proxies(site):
        try:
            ...
            with open('misc/proxies.txt', 'a') as proxy_file:
    ...
    def count_proxies():
        try:
            proxies = sum(1 for line in open('misc/proxies.txt', 'r'))
            return proxies
        except Exception as Error:
            return Error
    countSC = 1
    ...
    print('\033[1;93m' + " Saved in" + '\033[1;90m' + " > " + '\033[1;37m' + f"./misc/proxies.txt")
