...
def MacAddrLookUp():
    ...
    try:
        oui = json_stats["macPrefix"]; oui = oui[:2]+":"+oui[2:4]+":"+oui[4:]
        company = json_stats["company"]
        blockStart = json_stats["blockStart"]
        blockEnd = json_stats["blockEnd"]
        blockSize = json_stats["blockSize"]
        blockType = json_stats["blockType"]
        updated = json_stats["updated"]
        isRand = json_stats["isRand"]
        isPrivate = json_stats["isPrivate"]
